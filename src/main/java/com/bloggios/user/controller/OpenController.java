...
public class OpenController {
    ...
    public ResponseEntity<ProfileResponse> getUserProfile(@RequestParam String userId, @AuthenticationPrincipal AuthenticatedUser authenticatedUser) {
        return ResponseEntity.ok(AsyncUtils.getAsyncResult(profileService.getUserProfile(userId, authenticatedUser)));
    }
